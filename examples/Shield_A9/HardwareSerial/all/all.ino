...
//  Номер телефона должен начинаться с кода страны, например, номер +7(012)345-67-89 указывается как 70123456789 или +70123456789
...
//  ==========================================================================================
//  ВАЖНО:
//  Если символы Кириллицы исходящих SMS сообщений некорректно отображаются на телефоне,
//  раскомментируйте функцию TXTsendCoding() в коде Setup(), выбрав одну из кодировок: GSM_TXT_CP866 / GSM_TXT_UTF8 / GSM_TXT_WIN1251.
//  Если символы Кириллицы входящих SMS сообщений некорректно отображаются в мониторе,
//  раскомментируйте функцию TXTreadCoding() в коде Setup(), выбрав одну из кодировок: GSM_TXT_CP866 / GSM_TXT_UTF8 / GSM_TXT_WIN1251.
//  В данном примере кодировка исходящих сообщений определена функцией TXTsendCodingDetect("п"), но
//  эту функцию нельзя использовать, если текст для SMS сообщений берётся не из скетча, а вводится из другого устройства.
//  ==========================================================================================
